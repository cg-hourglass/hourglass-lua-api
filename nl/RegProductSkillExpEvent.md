...
# RegProductSkillExpEvent

## NL.RegProductSkillExpEvent(Dofile, FuncName)

### 函数功能

注册对象获得生产技能经验时触发的 Lua 函数，可以改写实际获得的技能经验。
...
- CharIndex: [数值型](../appendix/数值型.md) 获得生产技能经验的玩家对象index，由引擎传入。
- SkillID: [数值型](../appendix/数值型.md) 生产技能 ID，由引擎传入。
