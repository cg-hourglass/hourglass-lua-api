...
## Char.SetPostOverEvent(Dofile, FuncName, CharIndex)

### 函数功能

为对象index登记“覆盖其他对象后”事件的 Lua 回调函数。
...
## PostOverEventCallBack(CharIndex, TargetCharIndex)
...
```lua
Char.SetPostOverEvent(nil, "MyPostOver", NpcIndex);
```
